...
export const VerificationTemplate = ({domain, token}: IVerificationTemplateProps) => {
			...
			<Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
				<Section className='text-center mb-8'>
					...
					<Text className='text-base text-black'>
						Спасибо за регистрацию в RuStream! Чтобы подтвердить свой адрес электронной почты, пожалуйста, перейдите по следующей ссылке:
					</Text>
